    ...
    <div class="container  content-container pb-5">
        ...
        <div class="row privacy-container">
            ...
            <div class="col-md-12 content">
                ...
                <p >
                    This privacy policy applies to the online services of Freelance Flow Ltd under the domain Trustfy.io, including any subdomains (hereafter called &ldquo;websites&rdquo;), as well as our social media sites on Facebook, Twitter and Instagram, hereafter called &ldquo;social media sites&rdquo;).
                    Personal data is information that relates to an identified or identifiable person. This includes, but is not limited to, information that could enable your identification, such as your name, telephone number, physical address or e-mail address. We collect and aggregate data for statistical purposes, such as when you visit our website. This data cannot be associated with your person and are not included under the term &ldquo;personal data&rdquo;. You can print or save this privacy policy through the standard methods made available by your browser.
                </p>
                <p  class="strong">
                    2.    Persons responsible and points of contact
                </p>
                <p>                    The processing of your personal information when visiting this website is done in accordance with the EU General Data Protection Regulation (GDPR). The corresponding point of contact:
                    <br>
                    <br>
                ...
                <p>
                    ...
                    <br>
                    <span class="strong">first and last name, address, telephone number, e-mail address </span>
                    <br>
                ...
                <p>
                    ...
                    <br>
                    Any information you provide to the afore mentioned service providers will not be forwarded to us by them. The only information we receive is that your payment has been completed.

                    The processing of data by the afore mentioned payment service providers is based on our legitimate interest, according to Art. 6 para. 1 lit. b and f of the GDPR, in providing our clients with comfortable and secure payment.
                </p>
                <p class="strong">
                ...
                <p>
                    ...
                    <br>
                    <br>
                    Data Protection Commission f&uuml;r 21 Fitzwilliam Square South, Dublin 2, D02 RD28 Dublin.
                </p>
                <p class="strong">
                    9. Data security
                </p>
