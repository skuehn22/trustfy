...
<table align='center' style="color: #0f0f0f; padding:25px; min-width:320px; border-radius: 5px; border: 2px solid #d4d4d4;" width="45%" cellspacing="0" cellpadding="0" bgcolor="#fff">
    ...
    <tr>
        <td style="text-align: center;">
            ...
            <p>&copy; <a href="http://www.trustfy.io" style="color: #1e8033; text-decoration: none; ">trustfy.io</a> 2019. All Rights Reserved. | <span class="terms"><a href="https://www.trustfy.io/en/terms" target="_blank">Terms and Conditions</a></span><br> <br></p>
            </span>
        </td>
    </tr>
</table>
