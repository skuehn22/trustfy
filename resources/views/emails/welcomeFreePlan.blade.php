                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="text-align: center; padding-bottom: 35px;">
                                        ...
                                        <p style="font-size: 13px;">Your plan has been sent to {{$client->email}}!</p>
                                        <p>We’ve saved it for you in your personal account.</p>

                                        <p>
                                            <strong>While you’re there, check out some other cool features!</strong>
                                            <ul  style="list-style: none;">
                                                <li>&#10004;  Personalize your payment plans with your logo and color</li>
                                                <li>&#10004;  Get an easy overview of your cash flow</li>
                                                <li>&#10004;  Request a payment release from your clients</li>
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        <p>
                                            <a href="https://www.trustfy.io/en/freelancer/dashboard" style="background-color: #19A3B8; text-decoration: none; border-color: #19A3B8; padding: 10px; color:#fff; font-size: 16px; border-radius: .25rem; transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out" class="btn btn-primary" target="_blank">Log in</a>
                                            <br><br>
                                        </p>
                                    </td>
                                </tr>
