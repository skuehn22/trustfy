                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        <p>
                                            <a href="{{ $data['planUrl'] }}" style="background-color: #19A3B8; text-decoration: none; border-color: #19A3B8; padding: 10px; color:#fff; font-size: 14px; border-radius: .25rem; transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out" class="btn btn-primary" target="_blank">View Plan</a>
                                            <br><br>
                                        </p>
                                    </td>
                                </tr>
